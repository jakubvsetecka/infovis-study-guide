...
\begin{tikzpicture}[scale=1.0,>={Stealth[round]}]
  % point cloud along a diagonal
  \foreach \p in {(-1.6,-1.3),(-1.1,-0.7),(-0.8,-1.0),(-0.4,-0.1),(-0.2,-0.5),
                  (0.1,0.3),(0.3,-0.1),(0.6,0.7),(0.9,0.4),(1.3,1.1),(1.6,0.9),
                  (0.0,0.0),(-0.6,-0.4),(1.0,0.9)}{
    \fill[tuwblue!55] \p circle (1.6pt);}
  % PC1 (long axis)
  \draw[->,thick,red] (0,0) -- (1.7,1.35) node[right]{\footnotesize PC1};
  \draw[red] (0,0) -- (-1.7,-1.35);
  % PC2 orthogonal
  \draw[->,thick,keygreen] (0,0) -- (-0.55,0.7) node[above left]{\footnotesize PC2};
  % one example perpendicular projection
  \draw[dotted,tuwdark] (0.6,0.7) -- (0.79,0.46);
  \fill[red] (0.79,0.46) circle (1.3pt);
  \node[tuwdark,font=\scriptsize] at (2.4,0.1) {project $\perp$ onto PC1};
\end{tikzpicture}
\end{center}
\end{exambox}
